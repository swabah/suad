...
function Footer() {
  ...
  return (
    <div>
  <div class=" px-2 md:px-7 lg:px-20 bg-[#070307] py-8 md:py-12">
      ...
      <div>
        ...
        <div class="text-center mt-5 md:mt-0 sm:text-left grid grid-cols-2 gap-5 md:gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
          {footeritems.map((data) => (
            <li
              className="text-lg font-medium text-[#fdfbfe] drop-shadow-lg shadow-[#72bf44] list-none opacity-90 capitailze"
            >
              {data.head}
