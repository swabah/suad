...
function Footer() {
  ...
  return (
    <div>
       {/* <Banner/> */}
  <div class=" px-2 md:px-7 lg:px-20 bg-[#032c4b] backdrop-blur-lg  py-12">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div
          class="flex justify-center text-[#72bf44] dark:text-teal-300 sm:justify-start"
        >
          <Link to='/'>
        ...
        <p
          class="mt-5 max-w-md text-center opacity-80 leading-relaxed text-[#ffff] dark:text-gray-400 sm:max-w-xs sm:text-left"
        >
        ...
        <div className='mt-5 flex justify-center text-[#ffff] gap-6 sm:justify-start md:gap-5'>
        ...
        <div class="text-center sm:text-left grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                    ...
                    >
                      {data.subhead.map((subitem) => (
                        ...
                        <li onClick={() => { window.scrollTo({top: 0, left: 0, behavior: 'smooth'});}}
                              className="text-[#ffff] opacity-80 transition hover:text-[#72bf44]/75 capitalize pt-3">
                          {subitem.item}
                        </li>
                        </Link>
                      ))}
