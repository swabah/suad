...
function HomeTwo() {
  return (
    <div className='w-full space-y-3 text-[#1c415d] h-auto xl:h-[850px] bg-gray-100  px-3 md:px-7 lg:px-20  py-7 md:p-12 lg:py-16 xl:py-20 '>
    ...
    <div className='w-full'>
      ...
      <p className='text-xs md:text-sm mt-3 md:mt-5 xl:mt-8 md:text-center w-full h-full'>Ahlussuffa Dars is located at Thathoor Shuhada Maqam, a historical Masjid situated in Thathoor, Near Mavoor, has a history of more than 100 years. With the boundless help of the natives of the Mahall, our Dars has more than 120 students who are pursuing their academic studies includes B.sc Physics, Computer programming, Commerce, Chartered Accountant and psychology courses etc, simultaneously. Ahlussuffa is blessed with the Edu-Friendly Atmosphere of Thathoor Shuhada Maqam and Spiritual guidance of Thathoor shuhada. And also the mindful interventions of thathoor natives gives us an extra energy to fly.</p>
    </div>
  </div>
  )
}
