  ...
  return (
    ...
    <div className="min-x-md max-w-2xl">
      <div className="text-center">
        <h1 className="mt-10 font-bold text-white text-xl md:text-3xl lg:text-5xl xl:text-7xl backdrop-shadow-lg drop-shadow-md shadow-black tracking-wide  text-shadow-lg uppercase" >{props.con}</h1>
