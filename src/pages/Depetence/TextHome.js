  ...
  return (
    ...
    <div className="min-x-md max-w-2xl">
      <div className="text-center">
        <h1 id='Aboreto-font' className="mt-10 md:mt-5 font-semibold text-white px-3 md:px-0 text-4xl md:text-5xl lg:text-5xl xl:text-7xl drop-shadow-xl tracking-wide uppercase opacity-80" >{props.con}</h1>
