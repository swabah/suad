  ...
  return (
    ...
    <div className="min-x-md max-w-2xl">
      <div className="text-center">
        <h1 className="mt-10 font-bold text-white px-3 md:px-0 text-4xl md:text-5xl lg:text-5xl xl:text-7xl backdrop-shadow-lg drop-shadow-lg text-shadow-lg shadow-black tracking-wide uppercase" >{props.con}</h1>
