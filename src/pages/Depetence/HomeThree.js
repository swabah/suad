...
function HomeThree() {
  return (
    ...
    <div className='w-full items-start font-light text-gray-700'>
      ...
      <div className='pt-7 md:pt-10 lg:pt-16 w-full h-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-rows-auto gap-y-5 lg:gap-y-0 md:gap-x-5 items-center justify-between'>
