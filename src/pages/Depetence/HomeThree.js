...
function HomeThree() {
  return (
    <div className='w-full text-[#1c415d] flex flex-col items-center py-4 md:py-10 lg:py-12 xl:py-14 h-auto px-5 md:px-12 lg:px-20 xl:px-44 bg-white'>
    ...
    <div className='w-full items-start font-light text-gray-700'>
      ...
      <div className='pt-7 w-full h-auto flex flex-wrap space-y-4 md:space-y-0 items-center justify-evenly'>
