...
function Homesix() {
  return (
    <div className='w-full  px-2 md:px-7 lg:px-20  h-auto xl:h-[330px] text-[#1c415d] bg-white flex flex-col items-start md:items-center md:justify-center  py-4 md:py-6 lg:py-10 text-center space-y-2 xl:space-y-5'>   
