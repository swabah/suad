...
function Homesix() {
  return (
    ...
    <h1 className='text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold tracking-wide text-start md:text-center capitalize'>Check out few of our <br />
     Fruitfull Video Lessons</h1>
