  ...
  return (
    <div className='w-full h-auto mt-3'>
        <div className='w-full h-auto  flex  items-start'>
          <h2  className='text-xl p-1.5 shadow-sm w-auto h-auto flex items-center px-7 rounded border bg-[#72bf44] font-medium drop-shadow-lg text-white backdrop-shadow-xl '>
             <span>MUAD</span> 
             <span className='pl-4 text-sm uppercase'>minors' union of Ahlussuffa dars</span>
          </h2>
        </div>
