    ...
    <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
      <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
        <thead class="bg-gray-50">
          <tr>
            <th scope="col" class="px-6 py-4 font-medium text-base text-gray-900">Name</th>
            <th scope="col" class="px-6 py-4 font-medium text-base text-gray-900">State</th>
            <th scope="col" class="px-6 py-4 font-medium text-base text-gray-900">Contact</th>
            <th scope="col" class="px-6 py-4 font-medium text-base text-gray-900">Email</th>
          </tr>
        </thead>
