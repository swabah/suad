			...
			<div   className='px-2 md:px-7 lg:px-20   pt-12  pb-12 '>
				...
				<div className='  text-[#1c415d] mt-10  mb-12 w-full h-full'>
        		    <div className='items-center w-full h-auto p-5 rounded-lg shadow-lg border grid grid-cols-1 gap-5 md:gap-0 grid-rows-auto lg:grid-cols-4'>
        		        <img className='object-cover w-full lg:w-96 h-52 rounded drop-shadow-md' src={library} alt="" />
				...
				<Fragment >
   				   <Accordion className='mt-8 lg:mt-12 ' open={open === 1}>
   				     <AccordionHeader className='border-none text-xs md:text-sm lg:text-base xl:text-lg w-full h-full bg-[#72bf44] px-1 md:px-2 lg:px-4 xl:px-6 text-white drop-shadow-lg shadow-md' onClick={() => handleOpen(1)}>
						Integrated studies between Islam  science Complete degree in science disciplines
   				     </AccordionHeader>
   				     <AccordionBody className='border-none text-xs md:text-sm lg:text-base xl:text-lg w-full h-full bg-[#72bf44] px-1 md:px-2 lg:px-4 xl:px-6 text-white drop-shadow-lg shadow-md'>
						Integrated studies between Islam  science Complete degree in science disciplines
   				     </AccordionBody>
   				   </Accordion>
   				   <Accordion className='mt-3 lg:mt-5 ' open={open === 2}>
   				     <AccordionHeader   className='border-none text-xs md:text-sm lg:text-base xl:text-lg w-full h-full bg-[#72bf44] px-1 md:px-2 lg:px-4 xl:px-6 text-white drop-shadow-lg shadow-md' onClick={() => handleOpen(2)}>
						Integrated studies between Islam  science Complete degree in science disciplines
   				     </AccordionHeader>
   				     <AccordionBody  className='border-none text-xs md:text-sm lg:text-base xl:text-lg w-full h-full bg-[#72bf44] px-1 md:px-2 lg:px-4 xl:px-6 text-white drop-shadow-lg shadow-md'>
						Integrated studies between Islam  science Complete degree in science disciplines
   				   ...
   				   <Accordion className='mt-3 lg:mt-5 ' open={open === 3}>
   				     <AccordionHeader  className='border-none text-xs md:text-sm lg:text-base xl:text-lg w-full h-full bg-[#72bf44] px-1 md:px-2 lg:px-4 xl:px-6 text-white drop-shadow-lg shadow-md' onClick={() => handleOpen(3)}>
						Integrated studies between Islam  science Complete degree in science disciplines
   				     </AccordionHeader>
   				     <AccordionBody className='border-none text-xs md:text-sm lg:text-base xl:text-lg w-full h-full bg-[#72bf44] px-1 md:px-2 lg:px-4 xl:px-6 text-white drop-shadow-lg shadow-md'>
						Integrated studies between Islam  science Complete degree in science disciplines
