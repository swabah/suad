...
function HS() {
  return (
    <div className='w-full h-full'>
        <SubHeadings subheading='HS Programmes'/>
        <div className='w-full hidden md:flex flex-col items-start select-none px-3 md:px-7 lg:px-20   mt-12  '>
          	<h2  className='text-base md:text-xl uppercase p-1 shadow-sm w-auto h-auto flex items-center px-5 rounded border bg-[#72bf44] font-medium drop-shadow-lg text-white backdrop-shadow-xl '>
          	   <span className='uppercase '>HS program</span> 
          	</h2>
        </div>
