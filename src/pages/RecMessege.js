  ...
  return (
    ...
    <div className='w-full text-[#1c415d] flex flex-col bg-white h-full   '>
      <SubHeadings subheading="President's Messege"/>
        ...
        <div className='w-full h-auto mt-3 md:mt-7 text-[#1c415d]pb-10 md:pb-16 xl:pb-20 text-lg flex flex-col md:flex-row items-center justify-between   px-2 md:px-7 lg:px-20 '>
            <div className='md:w-1/2 h-full text-gray-600'>
                ...
                <h1 className='font-semibold   text-sm mt-8'>Rector'</h1>
            ...
            <div className='md:w-1/2 h-full flex items-center justify-center relative mt-7 md:mt-0'>
                ...
                <img className='rounded-md shadow-xl md:h-80 md:w-72 lg:h-96 object-cover lg:w-80 z-10' src={arshadusthad} alt="" />
            </div>
        </div>
    </div>
  )
