...
function SuffaDigi() {
  return (
    ...
    <div className='w-full  flex flex-col items-start select-none px-3 md:px-7 lg:px-20   mt-12  '>
        <h2  className='text-base md:text-xl uppercase p-1 shadow-sm w-auto h-auto hidden  md:flex items-center px-5 rounded border bg-[#72bf44] font-medium drop-shadow-lg text-white backdrop-shadow-xl '>
